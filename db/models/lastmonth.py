...
from ..sa_models import LastMonthModel

__all__ = ("LastMonth", "LastMonthCreate")


class LastMonthBase(BaseModelBase):
    __sa_model__ = LastMonthModel
...
class LastMonth(LastMonthBase, ModelBase):
    index: int


class LastMonthCreate(LastMonthBase):
    pass

LastMonthBase.update_forward_refs(**locals())
LastMonth.update_forward_refs(**locals())
LastMonthCreate.update_forward_refs(**locals())